      ...
      <div v-else class="space-y-4">
        <div class="relative mx-auto max-w-xs">
          ...
          <button
            ...
            class="absolute -top-2 -right-3 bg-red-500 text-white rounded-full p-1.5 shadow-lg hover:bg-red-600 transition-colors"
        ...
        <p class="text-xs text-green-400 text-center">Imagen cargada</p>
      </div>
    </div>
    <input
      type="file"
