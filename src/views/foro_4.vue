      ...
      <div class="flex-1 p-4 sm:p-6 md:p-8 lg:p-12">
        <div class="mx-auto max-w-5xl">
          ...
          <div v-if="cargandoEstado" class="text-center py-10">
            <p class="text-indigo-200 text-xl animate-pulse">
              Cargando actividad...
            </p>
          </div>
          ...
          <section v-else-if="!usuarioYaParticipo" class="animate-fade-in">
            ...
            >
              <h2 class="text-white text-base font-bold mb-4">
                Datos de Referencia
              </h2>
              <p class="text-gray-300 mb-6">
                Dada la siguiente tabla de la DMO de la cadera de las mujeres y
                la edad:
              </p>

              <div
                class="overflow-hidden rounded-lg border border-gray-600 max-w-lg mx-auto"
              >
                <table class="w-full text-sm text-left text-gray-400">
                  ...
                  <tbody class="divide-y divide-gray-700">
                    <tr class="bg-[#222d3e] hover:bg-[#2a3649]">
                      <td class="px-6 py-2 text-center font-bold text-white">
                        15
                      </td>
                      <td class="px-6 py-2 text-center">0.847</td>
                    </tr>
                    <tr class="bg-[#1e2837] hover:bg-[#2a3649]">
                      <td class="px-6 py-2 text-center font-bold text-white">
                        25
                      </td>
                      <td class="px-6 py-2 text-center">0.890</td>
                    </tr>
                    <tr class="bg-[#222d3e] hover:bg-[#2a3649]">
                      <td class="px-6 py-2 text-center font-bold text-white">
                        35
                      </td>
                      <td class="px-6 py-2 text-center">0.896</td>
                    </tr>
                    <tr class="bg-[#1e2837] hover:bg-[#2a3649]">
                      <td class="px-6 py-2 text-center font-bold text-white">
                        45
                      </td>
                      <td class="px-6 py-2 text-center">0.913</td>
                    </tr>
                    <tr class="bg-[#222d3e] hover:bg-[#2a3649]">
                      <td class="px-6 py-2 text-center font-bold text-white">
                        55
                      </td>
                      <td class="px-6 py-2 text-center">0.838</td>
                    </tr>
                    <tr class="bg-[#1e2837] hover:bg-[#2a3649]">
                      <td class="px-6 py-2 text-center font-bold text-white">
                        65
                      </td>
                      <td class="px-6 py-2 text-center">0.769</td>
                    </tr>
                    <tr class="bg-[#222d3e] hover:bg-[#2a3649]">
                      <td class="px-6 py-2 text-center font-bold text-white">
                        75
                      </td>
                      <td class="px-6 py-2 text-center">0.696</td>
                    </tr>
                    <tr class="bg-[#1e2837] hover:bg-[#2a3649]">
                      <td class="px-6 py-2 text-center font-bold text-white">
                        85
                      </td>
                      <td class="px-6 py-2 text-center">0.625</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            >
              ...
              <div>
                <h3 class="text-base text-white/90 mb-2 font-medium">
                  ...
                  <a
                    ...
                    >hoja de cálculo de Google Drive</a
                  >
                  para generar la función que mejor aproxime los puntos y por lo
                  tanto puede modelar este fenómeno. Obtén su expresión
                  algebraica.
                </h3>
                <a
                  href="https://drive.google.com/file/d/1OgW5vZDYPk73MPUSOJ7xMfFA93FEvzUt/view?usp=sharing"
                  class="inline-flex items-center gap-2 text-xs bg-red-900/30 text-red-300 px-2 py-1 rounded hover:bg-red-900/50 transition-colors mb-3 border border-red-800"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <textarea
                  v-model="r1"
                  rows="2"
                  placeholder="Escribe la expresión algebraica..."
                  class="input-foro"
                ></textarea>
              </div>
              ...
              <div>
                <h3 class="text-base text-white/90 mb-3 font-medium">
                  2. Explica las consideraciones que tomaste en cuenta para
                  elegir la función que mejor aproxima los puntos.
                </h3>
                <textarea
                  v-model="r2"
                  rows="3"
              ...
              <div>
                <h3 class="text-base text-white/90 mb-3 font-medium">
                  3. La función que elegiste ¿coincide con la evolución en la
                  DMO a lo largo de la vida? Explica ampliamente tu respuesta.
                </h3>
                <textarea
                  v-model="r3"
                  rows="3"
              ...
              <div>
                <h3 class="text-base text-white/90 mb-3 font-medium">
                  4. Calcula, usando la expresión algebraica, la densidad
                  mineral ósea para una edad aleatoria de la tabla y verifica si
                  el resultado obtenido es consistente. ¿Es el mismo valor? ¿A
                  qué se debe?
                </h3>
                <textarea
                  v-model="r4"
              ...
              <div>
                <h3 class="text-base text-white/90 mb-3 font-medium">
                  5. Con la expresión algebraica podemos obtener el valor de la
                  DMO para cualquier edad. Argumenta e indica ¿qué ventajas se
                  pueden tener si completamos la tabla anterior pero ahora con
                  intervalos más pequeños, por ejemplo, de un año en un año?
                </h3>
                <textarea
                  v-model="r5"
                  rows="3"
              ...
              <div>
                <h3 class="text-base text-white/90 mb-2 font-medium">
                  6. Elabora una tabla de año en año usando la segunda hoja del
                  documento que subimos a Google Drive y realiza su gráfica.
                </h3>
                <a
                  href="https://www.canva.com/design/DAGPpllYKuA/A2O1-5xRxdaHas-Yb5jHcw/edit?utm_content=DAGPpllYKuA&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton"
                  class="inline-flex items-center gap-2 text-xs bg-red-900/30 text-red-300 px-2 py-1 rounded hover:bg-red-900/50 transition-colors mb-3 border border-red-800"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <textarea
                  v-model="r6"
                  rows="3"
                  placeholder="Describe la grafica..."
                  class="input-foro"
                ></textarea>
              </div>
              ...
              <div>
                <h3 class="text-base text-white/90 mb-3 font-medium">
                  7. Argumenta ejemplificando detalladamente la siguiente
                  afirmación:
                  <em
                    class="block mt-2 pl-4 border-l-2 border-blue-600 text-gray-400"
                  >
                    "Con la expresión algebraica podemos obtener el valor de la
                    DMO para cualquier edad, es decir se puede obtener la DMO de
                    la cadera en cualquier momento de la vida, por ejemplo, a
                    los 38.6 años, esto indica que el fenómeno de variación es
                    continuo y la función elegida también es continua."
                  </em>
                </h3>
                <textarea
                  v-model="r7"
                  rows="4"
                  placeholder="Tu argumentación..."
                  class="input-foro"
                ></textarea>
              </div>
          ...
          <section v-else class="animate-fade-in">
            ...
            <div class="space-y-6">
              ...
              >
                ...
                <div
                  class="space-y-4 text-gray-300 text-sm pl-4 border-l border-gray-700/50"
                >
                  <p>
                    <strong class="text-indigo-200">1. Función:</strong>
                    {{ item.r1 }}
                  </p>
                  <p>
                    <strong class="text-indigo-200">2. Consideraciones:</strong>
                    {{ item.r2 }}
                  </p>
                    ...
                    >
                      <p>
                        <strong class="text-indigo-200"
                          >3. Coincidencia:</strong
                        >
                        {{ item.r3 }}
                      </p>
                      <p>
                        <strong class="text-indigo-200"
                          >4. Verificación:</strong
                        >
                        {{ item.r4 }}
                      </p>
                      <p>
                        <strong class="text-indigo-200"
                          >5. Ventajas intervalos:</strong
                        >
                        {{ item.r5 }}
                      </p>
                      <p>
                        <strong class="text-indigo-200"
                          >6. Gráfica anual:</strong
                        >
                        {{ item.r6 }}
                      </p>
                      <p>
                        <strong class="text-indigo-200">7. Continuidad:</strong>
                        {{ item.r7 }}
                      </p>
                    </div>
                  </details>
