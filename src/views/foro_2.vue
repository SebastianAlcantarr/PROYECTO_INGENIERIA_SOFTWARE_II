            ...
            <div class="space-y-6">
              ...
              >
                ...
                <div class="space-y-4 text-gray-300 text-xl pl-2 border-l border-gray-700 ml-4">
                  <p><strong class="text-blue-200">1.Similitudes y Diferencias</strong> <br>{{ item.r1 }}</p>
                  <p><strong class="text-blue-200">2:¿En qué etapa de la vida aumenta más la densidad mineral</strong> <br>{{ item.r2 }}</p>
                  ...
                  <details class="text-gray-400 cursor-pointer group">
                    ...
                    <div class="mt-2 space-y-4 pt-2 border-t border-gray-700/50 animate-fade-in">
                      <p><strong class="text-blue-200">3. ¿En qué etapa de la vida disminuye más la densidad mineral </strong> <br>{{ item.r3 }}</p>
                      <p><strong class="text-blue-200">4. ¿Habrá una edad donde la densidad mineral ósea tenga un valor máximo?</strong> <br>{{ item.r4 }}</p>
                      <p><strong class="text-blue-200">5. Analiza la siguiente afirmación </strong> <br>{{ item.r5 }}</p>
                      <p><strong class="text-blue-200">6. ¿Cómo podemos verificar o encontrar la edad dónde se alcanza el valor óptimo? </strong> <br>{{ item.r6 }}</p>
                    </div>
                  </details>
