        ...
        <div class="max-w-7xl ">
          ...
          <section class="scroll-mt-20" id="rules">
            <h2 class="text-white text-2xl font-bold px-4 pb-10 pt-20">
              El siguiente gráfico comparativo se elaboró a partir de los datos del <a class="text-blue-600 hover:text-blue-900 transition-colors duration-200 " href="https://e-enm.org/journal/view.php?doi=10.3803/EnM.2013.28.3.180">articulo de investigacion</a>
              de Lee y colaboradores (2013, p. 184). El gráfico muestra los valores de la cadera (Total hip) tanto de hombres como de mujeres.

            </h2>

            <div class="rounded-xl overflow-hidden px-4">
              <img
                  class="w-full md:w-[80%] lg:w-[70%] xl:w-[60%] mx-auto rounded-xl object-contain"
          ...
          <div class="space-y-4 mt-10">
            <div class="bg-[#161d2b] p-4 rounded-xl">
              ...
              <div
                  class="mt-8 pt-4 border-t border-gray-700 flex justify-end"
              >
                <button
