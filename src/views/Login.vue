              ...
              <div class="flex w-full justify-center">
                ...
                >
                  ...
                  <div class="flex flex-col gap-6">
                    ...
                    >
                    <button class="w-full h-12 px-6 rounded-lg bg-blue-400 hover:bg-blue-800 text-gray-900 font-semibold flex items-center justify-center duration-500 focus:ring-2 focus:ring-blue-400/50">
                      Iniciar Sesión
                    </button>
