      ...
      <div class="flex-1 p-4 sm:p-6 md:p-8 lg:p-12">
        <div class="mx-auto max-w-8xl">
              ...
              >
                ...
                >
                  <div class="flex flex-col gap-2 text-left">
                    <h1 class="text-white text-2xl p-6 leading-tight tracking-[-0.033em] @[480px]:text-5xl @[480px]:font-black @[480px]:leading-tight @[480px]:tracking-[-0.033em]">
          ...
          <section class="scroll-mt-20" id="rules">
            <h2
                class="text-white text-3xl font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-10 "
            >
              Manipula el Applet de Geogebra y responde las preguntas
            </h2>
              ...
              <div class="bg-[#161d2b] rounded-xl p-10">
                ...
                >
                  <div class="relative w-full mb-1">
                    <div id="geogebra-container" class=""></div>
                  </div>
                </div>
              </div>
            </section>
            ...
            <div class="space-y-4 mt-10">
              <div class="bg-[#161d2b] p-4 rounded-xl">
                <p class="= text-2xl font-bold text-white/90 mb-6">
                  ...
                  Observa qué pasa con la pendiente de la recta secante (o razón promedio de cambio) cuando los puntos se aproximan entre si, es decir, cuando el intervalo de las edades (Δx
                  ) se hace cada vez más pequeño (Δx→0
                  ) .
                </p>
                ...
                <p class="text-2xl font-bold text-white/90 mb-6">
                  ...
                  ) para distintos pares de puntos de la curva que mejor aproxima el fenómeno. Y responde las siguientes preguntas:

                  a) ¿Cuánto vale la Densidad Mineral Ósea a los 19 años? ¿Cuál será la razón instantánea de cambio a los 19 años?

                  b) ¿Cuánto vale la Densidad Mineral Ósea a los 31 años? ¿Cuál será la razón instantánea de cambio a los 31 años?

                  c) ¿Cuánto vale la Densidad Mineral Ósea a los 84 años? ¿Cuál será la razón instantánea de cambio a los  84 años?
                </p>
                ...
                <p class="text-2xl font-bold text-white/90 mb-6">
                  ...
                  a) Obtén la edad en que se alcanza el óptimo utilizando la definición formal de derivada.
